...
""")
  ...
  def test_no_reduction_possible(self):
    ...
    self._write_sh_script(test_sh_file.full_path, [
        '/usr/bin/env grep not.1.*x $1', '/usr/bin/env grep add.2.*not.1.*y $1',
...
"""
    ...
    self._write_sh_script(test_sh_file.full_path, ['/usr/bin/env grep not.*x $1'])
    minimized_ir = subprocess.check_output([
        IR_MINIMIZER_MAIN_PATH, '--test_executable=' + test_sh_file.full_path,
        ir_file.full_path
    ])
...
"""
    ...
    self._write_sh_script(test_sh_file.full_path, ['/usr/bin/env grep "tuple(.*x" $1'])
    minimized_ir = subprocess.check_output([
        IR_MINIMIZER_MAIN_PATH, '--test_executable=' + test_sh_file.full_path,
        ir_file.full_path
    ])
...
"""
    ...
    test_sh_file = self.create_tempfile()
    self._write_sh_script(test_sh_file.full_path,
                          [r'/usr/bin/env grep "bits\[32\]\[[123]\]" $1'])
    minimized_ir = subprocess.check_output([
...
"""
    ...
    self._write_sh_script(test_sh_file.full_path, ['/usr/bin/env grep test_node $1'])
    minimized_ir = subprocess.check_output([
        IR_MINIMIZER_MAIN_PATH, '--test_executable=' + test_sh_file.full_path,
        ir_file.full_path
    ])
...
"""
    ...
    self._write_sh_script(test_sh_file.full_path, ['/usr/bin/env grep bits.42 $1'])
    minimized_ir = subprocess.check_output([
        IR_MINIMIZER_MAIN_PATH,
        '--test_executable=' + test_sh_file.full_path,
        ir_file.full_path,
